...
class VolatilityPositionSizer:
    ...
    def get_details(self) -> Dict:
        ...
        return {
            "last_calculation": self.last_calculation_timestamp.isoformat() if self.last_calculation_timestamp else None,
    ...
    def update_config(self, **kwargs) -> None:
        ...
        for key, value in kwargs.items():
            if hasattr(self.config, key):
                setattr(self.config, key, Decimal(str(value)) if isinstance(value, (int, float)) else value)
