...
class TestNormalizeOrderFunction:
    ...
    def test_normalize_order_multiple_symbols(self, manager):
        ...
        price_btc, qty_btc, valid_btc, _ = normalize_order(manager, "BTCUSDT", 30000.123, 0.1234)
        ...
        price_eth, qty_eth, valid_eth, _ = normalize_order(manager, "ETHUSDT", 1800.456, 0.567)
